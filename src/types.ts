...
export const TRANSLATIONS = {
  en: {
    ...
    expiryPro: 'Expiry Pro',
    expiryProSub: 'Turn expired stock back into cash',
    addBill: 'Scan / Add Bill',
    recoverableNow: 'Recoverable Now',
    expiringSoon: 'Expiring Soon',
    alreadyLost: 'Already Lost',
    fileIntimation: 'File Intimation',
    returnNow: 'Return Now',
    intimateBy: 'Intimate by',
    graceEnds: 'Grace ends',
    source: 'Source',
    unverified: 'Unverified',
    verified: 'Verified',
    unresolvedBrand: 'Needs Brand Mapping',
    unresolvedCompany: 'Needs Return Policy',
    addPolicy: 'Add Policy',
    addMapping: 'Map Brand',
    proLockedText: 'Expiry Pro — turn expired stock back into cash. See what you could recover.',
    unlockPro: 'Unlock Expiry Pro',
    demoMode: 'Demo / Test Mode',
    diagnosticPass: 'All 100% Correct',
    verifyEngine: 'Verify Engine Math',
  },
  ur: {
    appName: 'AsquafMedical',
    customers: 'گاہک',
    ...
    expiryPro: 'ایکسپائری پرو',
    expiryProSub: 'اپنی ایکسپائر شدہ ادویات کو واپس نقد رقم میں تبدیل کریں',
    addBill: 'بل شامل کریں / اسکین کریں',
    recoverableNow: 'قابل واپسی رقم',
    expiringSoon: 'جلد ایکسپائر',
    alreadyLost: 'ضائع شدہ رقم',
    fileIntimation: 'اطلاع فائل کریں',
    returnNow: 'ابھی واپس کریں',
    intimateBy: 'اطلاع کی تاریخ:',
    graceEnds: 'واپسی کی آخری تاریخ:',
    source: 'ذریعہ:',
    unverified: 'غیر تصدیق شدہ',
    verified: 'تصدیق شدہ',
    unresolvedBrand: 'برانڈ جوڑیں',
    unresolvedCompany: 'پالیسی درکار ہے',
    addPolicy: 'پالیسی شامل کریں',
    addMapping: 'برانڈ جوڑیں',
    proLockedText: 'ایکسپائری پرو - اپنی ایکسپائر شدہ دواؤں کو واپس نقد میں تبدیل کریں۔ دیکھیں آپ کتنی رقم بچا سکتے ہیں۔',
    unlockPro: 'ایکسپائری پرو انلاک کریں',
    demoMode: 'ٹیسٹ موڈ',
    diagnosticPass: 'تمام حسابات بالکل درست ہیں',
    verifyEngine: 'حسابات کی تصدیق کریں',
  }
};
